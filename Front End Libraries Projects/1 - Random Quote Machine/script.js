...
function getQuote() {
  ...
  $('#tweet-quote').attr(
    'href',
    'https://twitter.com/intent/tweet?hashtags=MetalGearQuoteMachine&related=freecodecamp&text=' +
      encodeURIComponent('"' + currentQuote + '" -' + currentAuthor)
  )

  $('#tumblr-quote').attr(
    'href',
    'https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=MetalGearQuoteMachine&caption=' +
